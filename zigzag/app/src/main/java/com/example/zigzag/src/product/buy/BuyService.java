...
import com.example.zigzag.src.product.buy.interfaces.ProductActivityView;
import com.example.zigzag.src.product.buy.interfaces.ProductRetrofitInterface;
...
class BuyService {
    ...
    BuyService(final ProductActivityView productActivityView) {
