...
class LoginService {
    ...
    void postSignIn(String id, String pw) {
        ...
        loginRetrofitInterface.signInTest(new SignInBody(id,pw)).enqueue(new Callback<SignInResponse>() {
            @Override
            public void onResponse(Call<SignInResponse> call, Response<SignInResponse> response) {
                ...
                // 통신 성공, api통신으로 반환된 response를 액티비티에 반환해준다.
                mLoginActivityView.signInSuccess(signInResponse.getSignInResult());
            }
